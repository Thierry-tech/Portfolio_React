...
const projects = [
  ...
  },
  {
    ...
    category: "Fullstack",
    description:
      "Ce portfolio  conçu et développé avec React, Vite et un design system personnalisé.",
    tags: ["React", "Vite", "CSS"],
  ...
  },
  {
    ...
    category: "Data Science",
    description:
      "NLP appliqué à l'analyse de sentiment sur des avis clients — visualisation des résultats avec Power BI.",
    tags: ["Python", "NLTK", "Power BI", "Pandas"],
